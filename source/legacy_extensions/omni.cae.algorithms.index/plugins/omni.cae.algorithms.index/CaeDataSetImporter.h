...
/// Importer for CaeDataSet. This calls `omni.cae.algorithms.index.impl.helpers.CaeDataSetImporter` to do the work of
/// populate a nv::index::IIrregular_volume_subset using a CaeDataSetPrim.
