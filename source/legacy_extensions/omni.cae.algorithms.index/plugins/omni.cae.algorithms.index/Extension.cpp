...
#define EXTENSION_NAME "omni.cae.algorithms.index.plugin"
...
public:
    void onStartup(const char* extId) override
    {
        ...
        // Retrieve and store the factory for creating CAE dataset importers
...
const struct carb::PluginImplDesc kPluginImpl = { EXTENSION_NAME, "Omni CAE IndeX Algorithms Plugin.", "NVIDIA",
