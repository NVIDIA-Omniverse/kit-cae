...
/**
 * Importer factory to let IndeX know of our CAE dataset importers.
 */
...
public:
    ...
    {
        return "nv::omni::cae::algorithms::index";
    }
...
/**
 * Needed to make Index aware of our CAE compute techniques.
 */
