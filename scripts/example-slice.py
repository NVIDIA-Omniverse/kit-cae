...
async def main():
    ...
    # 1. Generate the slice visualization
    dataset_path: str = "/World/StaticMixer_cgns/Base/StaticMixer/B1_P3"
    slice_path: str = "/World/CAE/IndeXSlice_B1_P3"
    omni.kit.commands.execute("CreateCaeIndeXSlice", dataset_path=dataset_path, prim_path=slice_path)
